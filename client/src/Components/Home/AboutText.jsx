      ...
      <Box className={classes.mainBox} data-aos="fade-up">
        <Box className={classes.aboutHeading}>
          ...
          <Typography className={classes.mainText}>
            ...
            Kolkata, West Bengal, India. I am an Computer Science Engineeer (CSE)
           , currently looking for opportunities to work with awesome
            organisation and folks.
            <Box className={classes.btnBox}>
              <Buttons props="See my works" redirectPath="/projects" />

              <Buttons props="Contact now" redirectPath="/contact" />
            </Box>
          </Typography>
        </Box>
      </Box>
